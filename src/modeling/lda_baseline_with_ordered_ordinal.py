...
EXP_DETAILS='LinearDiscriminantAnalysis Solver lsqr. Categorical features LabelEncoding, StandardScaling'
...
combined_df = pd.DataFrame(combined_df, columns=feature_names)
...
logger.info(f'Model Built {model}')
...
result_dict = utility.make_sklearn_prediction_classification(logger, run_id, train_X, train_Y, test_X, 
                                                     features=features,
                                                     seed=SEED, 
